...
config.bind('c', 'open -t -- {clipboard}', mode='normal')
config.bind('j', 'scroll-px 0 125')
config.bind('k', 'scroll-px 0 -125')
config.bind('B', 'config-cycle tabs.show multiple never;; config-cycle statusbar.show always never')
config.bind('m', 'hint links spawn mpv {hint-url}')


c.scrolling.smooth = False
c.content.autoplay = False
c.content.headers.user_agent = 'Mozilla/5.0 (Wayland like X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36'
...
config.set('colors.webpage.darkmode.enabled', False, '*://*.wikipedia.org/*')
...
c.fonts.default_family = '12pt fixed'
c.fonts.tabs.selected = '12pt fixed'
c.fonts.tabs.unselected = '12pt fixed'
