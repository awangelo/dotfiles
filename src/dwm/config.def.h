...
static const unsigned int gappx     = 15;        /* gaps */
static const unsigned int snap      = 32;       /* snap pixel */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const char *fonts[]          = { "JetBrains Mono NerdFont:size=10", "Noto Color Emoji:size=10" };
...
static const char *clipmenucmd[] = { "clipmenu", "-c", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_accent, "-sf", col_gray4, NULL };
...
static const char *br_p[] = { "sh", "-c", "brightnessctl s +10%", NULL };
static const char *br_m[] = { "sh", "-c", "brightnessctl s 10%-", NULL };
...
static const Key keys[] = {
	...
	{ 0,               XF86XK_MonBrightnessUp, spawn,          {.v = br_p } },
	{ 0,             XF86XK_MonBrightnessDown, spawn,          {.v = br_m } },
	{ MODKEY|ShiftMask,             XK_w,      spawn,          SHCMD("exec ~/.config/scripts/wallpaper.sh") },
	...
	{ MODKEY,                       XK_w,      unfloatvisible, {.v = &layouts[0]} },
