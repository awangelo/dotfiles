...
static const Rule rules[] = {
	...
	{ "steam_app_2357570", NULL, NULL,     1 << 4,       1,           -1 },
};
...
static const char *dmenu_unicode[] = { "/home/angelo/.config/unicode_dmenu.sh", NULL };
